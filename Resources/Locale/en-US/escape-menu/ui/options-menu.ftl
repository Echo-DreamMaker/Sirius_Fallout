...
ui-options-chat-highlight-terms = Local chat highlights (separate words or phrases with semicolons)
ui-options-chat-highlight-terms-placeholder = Your character's first and last name
ui-options-chat-highlight-color = Highlight color (hex)
...
ui-options-fallout-progress-bar = Fallout progress bar
...
ui-options-function-open-a-help = Admin Help
