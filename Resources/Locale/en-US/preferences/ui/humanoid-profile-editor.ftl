...
humanoid-profile-editor-species-info-tooltip = Species Information
humanoid-profile-editor-variant-label = Variant:
humanoid-profile-editor-vocal-style-label = Vocal Style:
humanoid-profile-editor-voice-label = Voice:
humanoid-profile-editor-play-button = Play
...
humanoid-profile-editor-open-image-button = Open Folder
...
humanoid-profile-editor-loadouts-label = Loadouts:
humanoid-profile-editor-loadouts-show = Show
