...
job-name-vaultmanagement = Администратор Волт-Тек
job-description-vaultmanagement = Вы — административный надзиратель корпорации, являющийся прямым представителем Волт-Тек. Обеспечьте бесперебойную работу объекта, управляйте его обитателями и принимайте трудные решения, которые никто другой не может. Ваша власть абсолютна. Эта роль зарезервирована для администраторов сервера.
