...
admin-fax-inbox = Входящие РУКОВОДСТВА:
admin-fax-inbox-empty = Факсы от РУКОВОДСТВА ещё не поступали.
admin-fax-inbox-toggle-show = Показать входящие
admin-fax-inbox-toggle-hide = Скрыть входящие
