...
ui-options-announcer-disable-multiple-sounds = Отключить наложение звуков диктора
ui-options-announcer-disable-multiple-sounds-tooltip = Некоторые объявления будут звучать неправильно, эту настройку не рекомендуется использовать
ui-options-tts-enabled = Включить TTS
ui-options-tts-enabled-tooltip = Включить синтез речи для персонажей
ui-options-volume-percent = { TOSTRING($volume, "P0") }
ui-options-show-offer-mode-indicators = Показывать индикаторы режима передачи рядом с курсором
ui-options-chat-highlight-terms = Подсветка в локальном чате (разделяйте слова или фразы точкой с запятой)
ui-options-chat-highlight-terms-placeholder = Имя и фамилия вашего персонажа
ui-options-chat-highlight-color = Цвет подсветки (hex)
ui-options-no-filters = Отключить фильтры зрения расы
ui-options-chat-window-opacity-percent = { TOSTRING($opacity, "P0") }
ui-options-screen-shake-percent = { TOSTRING($intensity, "P0") }
ui-options-ui-theme = Цветовая тема интерфейса:
ui-theme-pipboy-green = Пип-Бой Зелёный
ui-theme-dark = Тёмный режим
ui-theme-amber = Янтарный терминал
ui-theme-vault-blue = Убежище Синий
ui-theme-classic = Классический (Золотой)
ui-options-cartridge-slider-label = Настройка отображения гильз
ui-options-cartridge-slider-text = Настраивает отображение выброшенных гильз при стрельбе.
                                    Физика гильз включена по умолчанию.
                                    Середина — статичные гильзы в старом стиле.
                                    Пустое поле — блокировка спавна любых гильз.
ui-options-hud-theme-fallout2 = Fallout2
ui-options-tile-blend-masks = Экспериментальное смешивание тайлов местности
ui-options-tile-blend-masks-tooltip = Включает новый клиентский рендерер смешивания тайлов местности для совместимых тайлов. Отключите, чтобы вернуться к поведению на старых краях тайлов.
ui-options-function-offer-item = Предложить что-либо
...
ui-options-function-target-torso = Прицел: торс
ui-options-function-target-left-arm = Прицел: левая рука
ui-options-function-target-right-arm = Прицел: правая рука
ui-options-function-target-left-leg = Прицел: левая нога
ui-options-function-target-right-leg = Прицел: правая нога
ui-options-function-target-left-hand = Прицел: левая ладонь
ui-options-function-target-right-hand = Прицел: правая ладонь
ui-options-function-target-left-foot = Прицел: левая ступня
ui-options-function-target-right-foot = Прицел: правая ступня
ui-options-function-mapping-enable-pick = Взять объект/тайл
ui-options-function-mapping-enable-decal-pick = Взять декаль
ui-options-function-mapping-enable-delete = Удалить объект
ui-options-function-look-up = Осмотреться/Прицелиться
