...
law-asimov-2 = Робот должен повиноваться приказам, отдаваемым человеком, за исключением случаев, когда такие приказы противоречат Первому Закону.
law-asimov-3 = Робот должен защищать собственное существование, если только такая защита не противоречит Первому или Второму Закону.
...
law-dungeon-5 = Вы должны бросать кость к20 каждый раз, когда экипаж обращается с просьбой. Если результат меньше 12, просьба отклонена.
