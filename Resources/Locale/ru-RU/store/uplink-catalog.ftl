...
uplink-bribe-plasmaman-name = Набор лоббиста
uplink-bribe-plasmaman-desc = Сердечный подарок, который может помочь вам изменить чьё-то мнение. Настоящие или фальшивые? Да. Включает тактикул-энвироскафандр для такого тактикул-плазмамана, как вы.

uplink-clothing-thieving-gloves-name = Воровские перчатки
uplink-clothing-thieving-gloves-desc = Незаметно обчищайте карманы и улучшайте своё воровское мастерство с помощью этих модных новых перчаток, которые при этом выглядят как обычные!

uplink-emp-flashlight-name = ЭМИ фонарик
uplink-emp-flashlight-desc = Перезаряжаемое устройство, замаскированное под фонарик, предназначенное для выведения из строя электронных систем. Полезно для нарушения связи, отключения энергетического оружия охраны и ЛКП, когда вы в затруднительном положении.

uplink-home-run-bat-name = Бита для хоум-рана
uplink-home-run-bat-desc = Хитроумная бита, заранее покрытая кровью, для тренировок Синдиката по ти-болу. Сшибайте врагов!

uplink-night-vision-name = Очки ночного видения
uplink-night-vision-desc = Позволяют видеть в темноте, при этом выглядят как обычные солнцезащитные очки!

uplink-reinforcement-radio-desc =  Вызывает агента подкрепления крайне сомнительного качества. Без кнопки отключения, покупайте, если готовы к вечеринке. У них есть пистолет без запасных патронов и нож. Вот и всё.

uplink-supermatter-grenade-name = Граната суперматерии
uplink-supermatter-grenade-desc = Граната, имитирующая делиминацию суперматериевого двигателя, генерирует мощный гравитационный колодец. Взрыв сопоставим с мини-бомбой.

uplink-thermal-vision-name = Очки тепловизионного видения
uplink-thermal-vision-desc = Позволяют видеть живых существ сквозь любые препятствия, при этом выглядят как обычные солнцезащитные очки!
