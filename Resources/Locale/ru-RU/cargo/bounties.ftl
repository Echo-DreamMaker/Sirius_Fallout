...
bounty-description-cardobard-box = «Картонные борги грядут» — новая пьеса, премьера которой завтра, а команда костюмеров совершенно не готова. Пришлите нам несколько коробок для работы.
