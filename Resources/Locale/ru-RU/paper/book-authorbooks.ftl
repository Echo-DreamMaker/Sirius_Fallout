...
book-text-legion-law =
 ...
 Ниже представлен свод законов Легиона, созванный советом центурионов и жриц Марса под руководством легата Джесикуса Эвиления и одобренный Августом Верусом Кальдием. Верно Марсу.

 === ЮРИДИЧЕСКИЕ ОПРЕДЕЛЕНИЯ ===

 Легио - Все земли, находящиеся под контролем детей Марса, верных богу войны и его Августу, и все те, кто сражается или проповедует во имя Марса.

 Плебей - любой взрослый человек, живущий на землях Легиона и платящий дань, но не сражающийся за Марса и не живущий и не марширующий с Легио Беллаторес. Сюда входят люди, живущие в городах-данниках, и караванщики, получившие право торговли на землях Легиона.

 Распутный - любой человек, живущий за пределами земель Легиона и не следующий за Марсом.

 Сервий - собственность; те, чей долг — служить и повиноваться своим хозяевам. Все дети младше 18 лет, женщины и монструмы по умолчанию считаются сервиями.

 Монструм - любой нечеловек, обладающий интеллектом, позволяющим говорить и действовать как человек.

 Легионер - член Легиона в его непосредственной командной структуре.

 Грехи - любые действия, считающиеся оскорблением Марса

 Гражданское и военное право - Гражданские правительства — это законы и правители тех городов, что платят дань Легиону, а также любой офицер Легиона, назначенный для надзора за ними. Военное, или «легио», правительство — это власть Беллаторес Марса напрямую.

 === УГОЛОВНЫЙ КОДЕКС ===

 Убийство плебея - незаконное убийство плебея. «Незаконным» считается убийство без уважительной причины — например, самообороны или наказания за вырождение.

 Убийство легионера - незаконное убийство любого легионера. Убийство женщин, выполняющих обязанности, прилегающие к боевым, — таких как ауксилиарии, фрументарии и разведчики, — во всех отношениях приравнивается к убийству легионера.

 Порча имущества - повреждение ценной вещи, принадлежащей другому, включая сервиев.

 Святотатство - любое действие, являющееся прямым нападением на Марса или его земных представителей. Сюда входят повреждение храмов и святилищ, а также нападения на членов жречества.

 Измена - действие, совершённое плебеем или легионером, направленное на ослабление или подрыв Легиона.

 Неповиновение - плебей, игнорирующий приказ легионера, или легионер, игнорирующий приказы вышестоящего офицера.

 Дезертирство - оставление Легиона, будучи действующим легионером.

 Вырождение - действия, морально или духовно развращённые либо ведущие к долгосрочному разложению легионера или Легиона в целом, особенно если они совершаются ради собственной выгоды или удовольствия.

 Трусость - отказ сражаться в выигрышном бою из страха.

 Коррупция - использование легионером ресурсов Легиона для достижения личных целей, особенно когда эти цели полностью эгоистичны.

 Кража - см. раздел «имущество».

 === ЗАПРЕЩЁННЫЕ ВЕЩЕСТВА ===

 Хотя ни один список не может охватить всё, общее правило таково: если вещество является сложным искусственно произведённым химикатом, для создания которого нужна продвинутая лаборатория или довоенные химикаты, либо оказывает на пользователя значительный вызывающий зависимость или изменяющий сознание эффект, оно незаконно.
 ...
 -БАФФОУТ
 -КЭТАЙ
 -СТИМПАК И СУПЕРСТИМПАК
 -АЛКОГОЛЬ
 -ТАБАК
 -ФИКСЕР - особенно презираем, поскольку позволяет скрывать зависимость и предаваться вырождению без последствий.

 ==== НАКАЗАНИЯ ====

 Наказания за преступление различаются в зависимости от ранга виновного в Легионе. Как правило, одно и то же преступление влечёт более суровое наказание, если его совершил высокопоставленный легионер, чем если его совершил сервий, плебей или легионер более низкого ранга.

 Повторим: центурионы обладают полной властью над жизнью и смертью людей своей когорты и, как правило, могут назначить любое наказание за любое преступление в разумных пределах. Однако центурион должен стремиться к тому, чтобы наказание соответствовало преступлению. Легионеру, говорившему непочтительно, могут вырвать язык; тот, кто бежит с поля боя, может быть брошен в яму с яогуайем с одним лишь ножом, и так далее. Но в целом существует шесть уровней наказания.

 1-Словесный: преступника позорят, высмеивают и относятся к нему с неуважением, его проступок рассказывают всем, и даже низшие чины могут обращаться с ним и говорить с ним без уважения.

 2-Телесный: преступника избивают, порют, секут или наносят ему увечья тем или иным образом.

 3-Понижение: преступника понижают в должности или, если он уже низкого ранга, а его преступление достаточно тяжкое, обращают в рабство.

 4-Распятие: преступника возлагают на крест.

 5-Фустуариум: преступника забивают до смерти и закалывают всем собравшимся Легионом, после чего оживляют с понижением в должности.

 6-Окончательная смерть: преступника убивают так, чтобы его нельзя было оживить. По умолчанию — сожжение дотла, чтобы огонь Марса очистил его душу.

 ==== ИМУЩЕСТВО ====

 В Легионе по-настоящему «владеть» имуществом не может никто, кроме Марса и Цезаря. Однако члены Легиона и плебеи могут «владеть» снаряжением и вещами в рамках понятий кражи, саботажа, а также хранения личного оружия, брони, богатства и припасов в практических целях. Отобрать эти вещи без уважительной причины, особенно тайно или исподтишка, — это преступление кражи и бесчестный поступок.

 Старшие офицеры Легиона сохраняют право реквизировать или передавать эти предметы, за тремя исключениями:

 Любое оружие или доспехи, добытые белатором на поле боя в результате убийства врага, по праву остаются его собственностью, ибо Марс даровал их ему в награду за силу и отвагу. Старший офицер не может требовать оружие и доспехи, добытые младшим легионером в честном бою, лишь потому, что желает их. Однако если такое снаряжение несёт символику другой нации, племени, веры или тому подобного, эта метка должна быть скрыта или изменена, прежде чем снаряжение можно будет использовать в бою.

 Штатное снаряжение: снаряжение, являющееся стандартным, базовым для определённого ранга или роли в Легионе, не может быть произвольно изъято или ограничено старшим офицером, за исключением индивидуальных случаев как наказание за конкретное нарушение. Его выдают не просто так.

 ==== ДУЭЛИ ====

 Дуэли — это взаимный бой между двумя лицами, начинающийся вследствие оскорблённой чести или предполагаемой слабости одного или обоих участников. Любой легионер может вызвать на дуэль любого другого легионера, за исключением того, что центурионов может оспорить на их должность только оптио или декан. Если законный вызов на дуэль отклонён, это считается признанием вины вызванной стороной.

 Дуэли проводятся без доспехов и с равным оружием; при этом должна присутствовать нейтральная третья сторона, в идеале жрица или офицер более высокого ранга, чем любой из дуэлянтов, чтобы руководить дуэлью.

 После определения победителя проигравший должен быть приведён в здоровое состояние. Побеждённый не может быть казнён за поражение, если только обвинение не было таким, которое обычно влечёт смертный приговор. Например: обвиняемый — центурион, употреблявший, как утверждается, запрещённые химикаты.

 Конкретные условия того, что ставит каждая сторона, должны быть определены до дуэли. Например, если дуэль проводится для оспаривания должности старшего офицера, об этом необходимо заявить заранее. Обвинитель должен предложить нечто равноценное тому, что он требует от обвиняемого, чтобы избежать множества мелких дуэлей без последствий для обвинителя в случае его поражения.

 === АДМИНИСТРАЦИЯ ===

 Гражданская администрация - относится к внутренним органам управления любых поселений плебеев. Эти правительства, как правило, полностью самоуправляемы и сами следят за порядком, за несколькими важными исключениями:

 -Плебейское правительство обязано подчиняться всем приказам и требованиям Легиона. Если требование признано чрезмерным или коррумпированным, правительство может подать легату прошение об его отмене, но до этого должно ему следовать. Злоупотребление этой властью центурионом влечёт суровое наказание.

 -Плебейское правительство не может издавать законы или допускать поведение, прямо противоречащее законам и морали Легиона и Марса.

 -Плебейское правительство не может по своей воле вступать в частные дипломатические отношения с любым другим образованием без согласия Легиона.

 Администрация Легиона - Каждый административный округ Легиона обычно сосредоточен вокруг каструма или аналогичного военного сооружения. Этими укреплениями командует центурион. Центурион, назначенный в регион, обладает полной властью над жизнью и смертью подчинённых ему Беллаторес. Это не значит, что его право на казнь не имеет ограничений. Центурион, уличенный в убийстве или наказании своих Беллаторес без уважительной причины, будет привлечён к ответственности.

 Полномочия назначенного в регион центуриона включают возможность издавать законы для плебейского населения этой области, если они не противоречат Закону Легиона, а также делать реквизиции ресурсов и людей у плебейского населения. Центурион может обратить в рабство любого распутного, обнаруженного в зоне его администрации.

 ==== РОЛИ И РАЗДЕЛЕНИЕ ПОЛНОМОЧИЙ МЕЖДУ ЖРЕЧЕСТВОМ И ЛЕГИОНОМ ====

 Жречество Марса включает всех женщин, служащих глашатаями и судьями воли Марса в Легионе. С юридической точки зрения они считаются собственностью Марса, поэтому любое нападение на них или причинение им вреда рассматривается как нападение на самого Марса. Любое обвинение жрицы в преступлении или грехе должно рассматриваться с особой осторожностью и тщательностью.

 Жрицы Марса обладают полной властью в порученном ей храме и командуют всеми ауксилиариями, аколитами и сервиями, как центурион — своими белаторами. Старшая жрица области имеет право обвинять и расследовать любые преступления религиозного характера, такие как богохульство или употребление греховных веществ, и имеет право определять наказание за подобные проступки.

 Командование между старшим офицером Легиона и старшей жрицей — это баланс, в котором ни одна сторона не должна выходить за пределы своих ролей и полномочий.

 ==== СТАТУС РАСПУТНЫХ И МЕНЕЕ ЗНАЧИМЫХ ГРУПП ====

 Женщины - рождённые Венерой; женщины не могут владеть собственностью и никогда не могут быть легионерами. Женщины, являющиеся членами Жречества, считаются собственностью Марса, владеющего ими напрямую.

 Сервий - любой человек, принадлежащий другому. Рабы каструма Легиона считаются принадлежащими Легиону в целом и подчиняются назначенному центуриону или тому, кому он поручил командование. Сервии должны подчиняться приказам своего господина.

 Монструм - существа, обладающие интеллектом уровня человека, но не являющиеся людьми. Они могут стать сервиями, но никогда не могут стать белаторами или членами Жречества.

 Распутные - те, кто живёт вне Легиона и его законов. У них нет никакой защиты на землях Легиона, даже меньшей, чем у сервиев. Могут быть сделаны особые исключения в каждом отдельном случае, например для визитов дипломатов из распутных наций.

 ==== ОБРАЩЕНИЕ С СЕРВИЯМИ ====

 Сервии, находящиеся в непосредственном владении Легиона, обязаны подчиняться любым и всем приказам Легиона, в первую очередь — ауксилиариям и членам жречества. В случае противоречивых приказов сервий должен подчиняться приказу самого старшего офицера. Сервии наказываются мягче, чем другие, поскольку они — самые новые и низшие члены Легиона, и их следует формировать множеством мелких наказаний. Вещи, за которые представителю высшего ранга грозила бы смерть или распятие, — такие как дерзость, употребление порочных веществ, распутная одежда, причёски, поведение или убеждения, — должны встречаться поркой и словесным порицанием.

 Однако это не означает, что с сервиями можно жестоко обращаться. Сервий — будущий легионер или ауксилиарий, его предназначение — служить, учиться и стать могучим оружием Марса. Наказание, избиение или жестокое обращение с сервием, который ни в чём не провинился или даже был усерден и непоколебим в своём труде, — это своего рода скрытая измена, отравляющая образ Легиона в глазах его будущего. Неоправданные притеснения сервиев учат их, что Легион не «суров, но справедлив», а просто жесток ради жестокости. Это нельзя терпеть.

 ==== ФРУМЕНТАРИИ ====

 Фрументарии являются исключением из всех перечисленных выше правил. Благодаря своему особому положению в Легионе они могут действовать безнаказанно, если могут предоставить разумные доказательства того, что их действия были необходимы для выполнения поставленной задачи, что эта операция принесла больше пользы, чем вреда, и что они действовали исключительно в интересах Легиона. Любой случай, когда фрументарий, как считается, превысил необходимые меры при нарушении обычных правил Легиона, должен быть передан старшему центуриону или легату.
