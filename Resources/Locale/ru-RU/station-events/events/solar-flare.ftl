...
station-event-solar-flare-announcement = Вблизи станции зафиксирована солнечная вспышка. Некоторые каналы связи могут не работать.

station-event-solar-flare-complete-announcement = Солнечная вспышка завершилась. Каналы связи больше не подвержены влиянию.
