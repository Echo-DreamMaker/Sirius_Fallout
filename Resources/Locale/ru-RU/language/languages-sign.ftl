...
chat-sign-language-whisper-wrap = [italic][BubbleHeader][Name]{$entityName}[/Name][/BubbleHeader] [BubbleContent]тонкие жесты [font="{$fontType}" size={$fontSize}][color={$color}]{$message}[/color][/font][/italic][/BubbleContent]

chat-speech-verb-sign-1 = жесты
chat-speech-verb-sign-2 = знаки
chat-speech-verb-sign-3 = волны