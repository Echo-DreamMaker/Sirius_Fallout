cassette-repair-start = Вы начинаете сматывать ленту обратно в {THE($item)}.
cassette-repair-finish = Вам удаётся смотать ленту обратно в {THE($item)}.
tape-cassette-position = Кассета прокручена примерно на [color=green]{$position}%[/color].
tape-cassette-damaged = Кассета размотана — используйте ручку или отвёртку, чтобы отремонтировать её.
tape-recorder-playing = Магнитофон находится в режиме [color=green]воспроизведения[/color].
...
tape-recorder-locked = Нельзя извлечь кассету, пока магнитофон работает.
...
tape-recorder-menu-cassette-label = Аудиокассета: {$cassetteName}
tape-recorder-menu-no-cassette-label = Аудиокассета не вставлена
