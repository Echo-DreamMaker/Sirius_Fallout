...
guidebook-food-processing-butchering = мясник
guidebook-food-processing-slicing = Срез
guidebook-food-processing-cooking = Микроволновая печь для {$time}s
...
guidebook-food-ingredient-liquid = добавить {$amount}u {$name}
