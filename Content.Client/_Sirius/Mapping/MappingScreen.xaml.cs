...
public sealed partial class MappingScreen : InGameScreen
{
    ...
    public MappingScreen()
    {
        ...
        DecalHexColorInput.OnTextChanged += OnDecalHexColorInput;
        ...
        PickDecal.Texture.TexturePath = "/Textures/_Sirius/Interface/VerbIcons/wand-magic-sparkles-solid.svg.192dpi.png";
        Flip.Texture.TexturePath = "/Textures/Interface/VerbIcons/rotate_cw.svg.192dpi.png";
        HideLeftSide.Texture.TexturePath = "/Textures/_Sirius/Interface/VerbIcons/caret-left-solid.svg.192dpi.png";
        HideRightSide.Texture.TexturePath = "/Textures/_Sirius/Interface/VerbIcons/caret-right-solid.svg.192dpi.png";

        Flip.OnPressed += _ => FlipSides();
        Visibility.Texture.TexturePath = "/Textures/_Sirius/Interface/VerbIcons/layer-group-solid.svg.192dpi.png";
        Visibility.OnPressed += _ => visibilityUIController.ToggleWindow();
        FixGridAtmos.Texture.TexturePath = "/Textures/_Sirius/Interface/VerbIcons/oxygen.svg.192dpi.png";
    ...
    private static void SetToggleButtonTexture(MappingActionsButton button, BoxContainer container)
    {
        if (container.GetPositionInParent() == 0)
        {
            button.Texture.TexturePath = container.Visible
                ? "/Textures/_Sirius/Interface/VerbIcons/caret-left-solid.svg.192dpi.png"
                : "/Textures/_Sirius/Interface/VerbIcons/caret-right-solid.svg.192dpi.png";
        }
        else
        {
            button.Texture.TexturePath = container.Visible
