...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class MiscTab : Control
    {
        ...
        public MiscTab()
        {
            ...
            var uiThemes = _prototypeManager.EnumeratePrototypes<UiThemePrototype>().ToList();
            uiThemes.Sort();
            for (var i = 0; i < uiThemes.Count; i++)
            {
                var theme = uiThemes[i];
                UiThemeOption.AddItem(Loc.GetString(theme.Name), i);
                UiThemeOption.SetItemMetadata(i, theme.ID);
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            // #Misfits Add - Save and apply the selected UI theme (rebuilds + reassigns the stylesheet).
        ...
        private void UpdateApplyButton()
        {
            ...
            var isUiThemeSame = UiThemeOption.SelectedMetadata is string themeId && themeId == _cfg.GetCVar(CCVars.UiThemePalette); // #Misfits Add
